...
let lexlang =  'et'; // Estonian: 'en', 'en'; // English: 'en', German: 'de', Dutch: 'nl', Chinese: 'ch1', Chinese incl. English: 'ch2'
    ...
    if (lextale_items.length > 0) {
       ...
       let lex_score = (corr_word - (2 * incorr_nonword));
        ...
        document.getElementById('end_summary_id').innerHTML =
            ...
            '</b> (out of 60)</span></b><br>Correctly identified real words: <b>' + corr_word +
